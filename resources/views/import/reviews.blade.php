@extends('layout')
@section('content')
	<form name="paste-data-form" method="POST" action="{{ URL::route( 'process-import-reviews' ) }}" accept-charset="UTF-8">
		<div class="row">
			<div class="col-md-5">
	            <h1>Paste Reviews</h1>
	        </div>
		...
		<div class="content">
			...
			<div class="form-group">
	            ...
	            <textarea name="reviews" class="form-control" rows="15"></textarea>
	        </div>
		</div>
